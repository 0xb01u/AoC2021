...
max_d = 0
for scanner1 in origs:
	coords1 = origs[scanner1]
	for scanner2 in origs:
		coords2 = origs[scanner2]
		d = abs(coords1[0] - coords2[0]) + abs(coords1[1] - coords2[1]) + abs(coords1[2] - coords2[2])
		max_d = d if d > max_d else max_d

print(f"Largest Manhattan distance between scanners: {max_d}")
assert max_d == 12140
