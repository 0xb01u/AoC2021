...
for _, number in pairs(numbers) do
	::next_board::
	for num_board, board in pairs(boards) do
			...
			for j_board, num in pairs(line) do
				if num == number then
					...
					if row or col then
						...
						won = 0
						for _, _ in pairs(win) do won = won- -1 end
						if won == #boards then
							score = 0
							for i = 0, 4 do
								for j = 0, 4 do
							...
							print("Final score for worst board: " .. score)
							assert(score == 34726)
							os.exit()
						--else
						--	goto next_board -- Using the goto is actually slower.
						end
					end
				end
			end
