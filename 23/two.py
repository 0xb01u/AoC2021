...
rooms = { "A": [(2, 3), (3, 3), (4, 3), (5, 3)], "B": [(2, 5), (3, 5), (4, 5), (5, 5)], "C": [(2, 7), (3, 7), (4, 7), (5, 7)], "D": [(2, 9), (3, 9), (4, 9), (5, 9)] }

walkable = set([(3, 3), (4, 3), (3, 5), (4, 5), (3, 7), (4, 7), (3, 9), (4, 9)])
stoppable = set([(3, 3), (4, 3), (3, 5), (4, 5), (3, 7), (4, 7), (3, 9), (4, 9)])

pos = { (3, 3): "D", (4, 3): "D", (3, 5): "C", (4, 5): "B", (3, 7): "B", (4, 7): "A", (3, 9): "A", (4, 9): "C" }
...
states = [State(pos)]
visited = set()
min_energy = 50300	# Trial and error.
moves = 0
while len(states) > 0:
	...
	if moves == 0:	# Debug
		...
		#[print(state.pos) for state in states]
		exit()

print(f"Least energy required to organize the amphipods: {min_energy}")	# 75s oof... But it does the thing.
assert min_energy == 50265
